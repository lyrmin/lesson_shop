...
if (!empty($arResult['ITEMS']))
{
    ...
    ?>
    <div class="bx_catalog_list_home col<?=$arParams['LINE_ELEMENT_COUNT']; ?> <?=$templateData['TEMPLATE_CLASS']; ?>">
        <?
        foreach ($arResult['ITEMS'] as $key => $arItem)
        {
            ...
            <div class="<? echo($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">
                <div class="bx_catalog_item_container" id="<?=$strMainID; ?>">
                    <a id="<?=$arItemIDs['PICT']; ?>" href="<?=$arItem['DETAIL_PAGE_URL']; ?>"
                       ...
                       title="<?=$imgTitle; ?>">
                        ...
                        {
                            ?>
                            <div id="<?=$arItemIDs['DSC_PERC']; ?>" class="bx_stick_disc right bottom" style="display:<? echo(0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'none'); ?>;">-<?=$minPrice['DISCOUNT_DIFF_PERCENT']; ?>%</div>
                            <?
                        }
                        ...
                        {
                            ?>
                            <div id="<?=$arItemIDs['STICKER_ID']; ?>" class="bx_stick average left top" title="<?=$arItem['LABEL_VALUE']; ?>"><?=$arItem['LABEL_VALUE']; ?></div>
                            <?
                        }
                        ?>
                    </a>
                    ...
                    {
                        ?>
                        <a id="<?=$arItemIDs['SECOND_PICT']; ?>" href="<?=$arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double" style="background-image: url('<?=(!empty($arItem['PREVIEW_PICTURE_SECOND']) ? $arItem['PREVIEW_PICTURE_SECOND']['SRC'] : $arItem['PREVIEW_PICTURE']['SRC']); ?>');" title="<?=$imgTitle?>">
                            <?
                            if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT'])
                            {
                                ?>
                                <div id="<?=$arItemIDs['SECOND_DSC_PERC']?>" class="bx_stick_disc right bottom" style="display:<? echo(0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'none')?>;">-<?=$minPrice['DISCOUNT_DIFF_PERCENT']; ?>%</div>
                                <?
                            }
                            ...
                            {
                                ?>
                                <div id="<?=$arItemIDs['SECOND_STICKER_ID']?>" class="bx_stick average left top" title="<?=$arItem['LABEL_VALUE']; ?>"><?=$arItem['LABEL_VALUE']; ?></div>
                                <?
                            }
                            ?>
                        </a>
                    ...
                    <div class="bx_catalog_item_title">
                        <a href="<?=$arItem['DETAIL_PAGE_URL']; ?>" title="<?=$productTitle?>"><?=$productTitle?></a>
                    </div>
                    ...
                    if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
                    {
                            ...
                            if ($arItem['CAN_BUY'])
                            {
                                if ('Y' == $arParams['USE_PRODUCT_QUANTITY'])
                                {
                                    ...
                                    <div class="bx_catalog_item_controls_blockone">
                                        <div style="display: inline-block;position: relative;">
                                            ...
                                            <span id="<?=$arItemIDs['QUANTITY_MEASURE']?>"><?=$arItem['CATALOG_MEASURE_NAME']?></span>
                                        </div>
                                    </div>
                                    <?
                                }
                                ?>
                                <div id="<?=$arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
                                ...
                                if ($arParams['DISPLAY_COMPARE'])
                                {
                                    ...
                                    <div class="bx_catalog_item_controls_blocktwo">
                                        <a id="<?=$arItemIDs['COMPARE_LINK']; ?>" class="bx_bt_button_type_2 bx_medium" href="javascript:void(0)"><?=$compareBtnMessage; ?></a>
                                    </div>
                                    <?
                                }
                            }
                                                ...
                                                <td>
                                                    ...
                                                    )
                                                    {
                                                        foreach ($propInfo['VALUES'] as $valueID => $value)
                                                        {
                                                            ?>
                                                            <label>
                                                                <input type="radio" name="<?=$arParams['PRODUCT_PROPS_VARIABLE']; ?>[<?=$propID; ?>]" value="<?=$valueID; ?>" <? echo($valueID == $propInfo['SELECTED'] ? '"checked"' : ''); ?> /><?=$value?>
                                                            </label>
                                                            <br />
                                                            <?
                                                        }
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        <select name="<?=$arParams['PRODUCT_PROPS_VARIABLE']; ?>[<?=$propID; ?>]">
                                                            ...
                                                            {
                                                                ?>
                                                                <option value="<?=$valueID?>" <? echo($valueID == $propInfo['SELECTED'] ? 'selected' : ''); ?>><?=$value?></option>
                                                                <?
                                                            }
                                                            ?>
                                                        </select>
                        ...
                        <script type="text/javascript">
                            var <?=$strObName?> = new JCCatalogSection(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
                        </script>
                        <?
                    }
                    else
                    {
                        if ('Y' == $arParams['PRODUCT_DISPLAY_MODE'])
                        {
                            ...
                            <div class="bx_catalog_item_controls no_touch">
                                ...
                                ?>
                                <div id="<?=$arItemIDs['NOT_AVAILABLE_MESS']; ?>" class="bx_catalog_item_controls_blockone" style="display: <?=($canBuy ? 'none' : '')?>;">
                                    <span class="bx_notavailable">
                                        <?=('' != $arParams['MESS_NOT_AVAILABLE'] ? $arParams['MESS_NOT_AVAILABLE'] : GetMessage('CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE'))?>
                                    </span>
                                </div>
                                <div id="<?=$arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo" style="display: <?=($canBuy ? '' : 'none'); ?>;">
                                    <a id="<?=$arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium" href="javascript:void(0)" rel="nofollow">
                                        <?
                                        if ($arParams['ADD_TO_BASKET_ACTION'] == 'BUY')
                                        {
                        ...
                        else
                        {
                            ...
                            <div class="bx_catalog_item_controls no_touch">
                                <a class="bx_bt_button_type_2 bx_medium" href="<?=$arItem['DETAIL_PAGE_URL']; ?>">
                                    <?=('' != $arParams['MESS_BTN_DETAIL'] ? $arParams['MESS_BTN_DETAIL'] : GetMessage('CT_BCS_TPL_MESS_BTN_DETAIL'));?>
                                </a>
                            </div>
                            <?
                        }
                        ?>
                            <div class="bx_catalog_item_controls touch">
                                <a class="bx_bt_button_type_2 bx_medium" href="<?=$arItem['DETAIL_PAGE_URL']; ?>"><?=('' != $arParams['MESS_BTN_DETAIL'] ? $arParams['MESS_BTN_DETAIL'] : GetMessage('CT_BCS_TPL_MESS_BTN_DETAIL'))?></a>
                            </div>
                        <?
